...
_C.MODEL.HEADS_NAME = ['']
_C.MODEL.PRETRAINED = '/home/xrh1/Downloads/epoch-66.pth' #"/home/xrh1/experiments/extra/YOLOP/runs/BddDataset/_2022-01-19-17-59/epoch-19.pth"
...
_C.DATASET.DATAROOT = '/home/xrh1/datasets/yolop_dataset/det_annotations/data2/zwt/bdd/bdd100k/images/100k'       # the path of images folder
_C.DATASET.LABELROOT = '/home/xrh1/datasets/yolop_dataset/det_annotations/data2/zwt/bdd/bdd100k/labels/100k'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/home/xrh1/datasets/yolop_dataset/bdd_seg_gt'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/home/xrh1/datasets/yolop_dataset/bdd_lane_gt'               # the path of ll_seg_annotations folder
...
_C.TRAIN.LR0 = 0.0003 #0.001 originally, 0.0003 after 20 epochs  # initial learning rate (SGD=1E-2, Adam=1E-3)
...
_C.TRAIN.BATCH_SIZE_PER_GPU = 20
